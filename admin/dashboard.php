...
<head>
  ...
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml;utf8,<?= rawurlencode(getFaviconSvg())?>">
...
?>
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
      <button onclick="switchTab('overview')" id="nav-overview"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50 active">
        <span>📊</span> Overview
      </button>
      <button onclick="switchTab('bookings')" id="nav-bookings"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>✈️</span> Bookings
      </button>
      <button onclick="switchTab('trips')" id="nav-trips"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>🏝️</span> Trips
      </button>
      <button onclick="switchTab('destinations')" id="nav-destinations"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>🌍</span> Destinations
      </button>
      <button onclick="switchTab('gallery')" id="nav-gallery"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>🖼️</span> Gallery
      </button>
      <button onclick="switchTab('blogs')" id="nav-blogs"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>📝</span> Blogs
      </button>
      <button onclick="switchTab('testimonials')" id="nav-testimonials"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>⭐</span> Testimonials
      </button>
      <button onclick="switchTab('site_stats')" id="nav-site_stats"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
        <span>📈</span> Site Stats
      </button>
      <button onclick="switchTab('site_settings')" id="nav-site_settings"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">
      ...
      <button onclick="switchTab('messages')" id="nav-messages"
        class="sidebar-link w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50 relative">
        <span>✉️</span> Messages
        <span id="unread-count"
          class="absolute right-4 bg-red-500 text-white text-[10px] w-5 h-5 rounded-full hidden items-center justify-center font-bold">0</span>
      </button>
    </nav>

    <div class="p-4 border-t border-gray-50">
      <a href="<?= FRONTEND_URL?>/" target="_blank"
        class="flex items-center gap-3 px-4 py-3 text-sm text-gray-400 hover:text-primary transition-colors">
        <span>🌐</span> View Website
      </a>
      <button onclick="logout()"
        class="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-400 hover:text-red-600 font-bold transition-colors">
        <span>🚪</span> Logout
      </button>
    </div>
  </aside>
  ...
  <main class="flex-1 min-w-0 flex flex-col">
    ...
    <header class="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-10">
      ...
      <div class="flex items-center gap-4">
        ...
        <div
          class="w-10 h-10 rounded-xl bg-primary text-white flex items-center justify-center font-bold shadow-lg shadow-primary/20">
          A</div>
      </div>
    </header>
