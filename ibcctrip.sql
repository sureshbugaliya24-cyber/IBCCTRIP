...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2026 at 01:00 PM
...
INSERT INTO `bookings` (`id`, `booking_ref`, `user_id`, `trip_id`, `start_date`, `end_date`, `duration_days`, `num_members`, `full_name`, `email`, `phone`, `special_notes`, `status`, `total_price`, `currency_code`, `base_price`, `created_at`, `updated_at`) VALUES
(1, 'IBCC-2026-0001', 2, 1, '2026-04-10', '2026-04-12', 3, 2, 'Rajesh Sharma', 'rajesh@example.com', '9811234567', NULL, 'Scheduled', 25998.00, 'INR', 25998.00, '2026-03-11 10:56:36', '2026-03-12 05:32:13'),
(2, 'IBCC-2026-0002', 3, 2, '2026-05-15', '2026-05-20', 6, 4, 'Priya Singh', 'priya@example.com', '9822345678', NULL, 'Pending', 79996.00, 'INR', 79996.00, '2026-03-11 10:56:36', '2026-03-11 10:56:36'),
(3, 'IBCC-2026-0003', 4, 3, '2026-03-20', '2026-03-23', 4, 3, 'Amit Patel', 'amit@example.com', '9833456789', NULL, 'In Progress', 29997.00, 'INR', 29997.00, '2026-03-11 10:56:36', '2026-03-11 10:56:36'),
(4, 'IBCC-2026-0004', 5, 4, '2026-06-05', '2026-06-09', 5, 2, 'Sunita Verma', 'sunita@example.com', '9844567890', NULL, 'Scheduled', 69998.00, 'INR', 69998.00, '2026-03-11 10:56:36', '2026-03-11 10:56:36'),
(5, 'IBCC-2026-0005', 6, 5, '2026-04-01', '2026-04-04', 4, 1, 'Mohammed Khan', 'mohammed@example.com', '9855678901', NULL, 'Completed', 49999.00, 'INR', 49999.00, '2026-03-11 10:56:36', '2026-03-11 10:56:36');
...
INSERT INTO `cities` (`id`, `state_id`, `name`, `slug`, `description`, `featured_image`, `is_featured`, `sort_order`, `created_at`) VALUES
(1, 1, 'Jaipur', 'jaipur', 'The Pink City, Jaipur is Rajasthan\'s capital, famous for Hawa Mahal, Amber Fort, City Palace, and vibrant bazaars.', NULL, 1, 0, '2026-03-11 10:56:35'),
(2, 3, 'New Delhi', 'new-delhi', 'New Delhi, India\'s capital, is a city that wears its history on its sleeve — from Mughal monuments to colonial boulevards.', NULL, 1, 0, '2026-03-11 10:56:35'),
(3, 2, 'Panaji', 'panaji', 'Panaji, Goa\'s capital, is a charming riverside city with colorful Portuguese-era houses, quirky cafes, and a laid-back vibe.', NULL, 1, 0, '2026-03-11 10:56:35'),
(4, 4, 'Phuket City', 'phuket-city', 'Phuket City, the cultural heart of the island, features Sino-Portuguese architecture, local markets, and street art.', NULL, 1, 0, '2026-03-11 10:56:35'),
(5, 5, 'Dubai City', 'dubai-city', 'Dubai City is the world\'s most visited city — home to the Burj Khalifa, Dubai Mall, and the iconic Palm Jumeirah.', NULL, 1, 0, '2026-03-11 10:56:35');
...
INSERT INTO `countries` (`id`, `name`, `slug`, `code`, `description`, `featured_image`, `flag_icon`, `is_featured`, `sort_order`, `created_at`) VALUES
(1, 'India', 'india', 'IN', 'India, the land of diverse cultures, ancient temples, royal palaces, and breathtaking landscapes. From the snow-capped Himalayas to tropical beaches, India offers an unparalleled travel experience.', NULL, '🇮🇳', 1, 1, '2026-03-11 10:56:35'),
(2, 'Thailand', 'thailand', 'TH', 'Thailand, the Land of Smiles, enchants travelers with its ornate temples, vibrant street food, idyllic beaches, and world-class hospitality.', NULL, '🇹🇭', 1, 2, '2026-03-11 10:56:35'),
(3, 'UAE', 'uae', 'AE', 'The United Arab Emirates blends ultramodern cities with desert adventures and traditional Arabian culture. Dubai and Abu Dhabi are world-class luxury destinations.', NULL, '🇦🇪', 1, 3, '2026-03-11 10:56:35'),
(4, 'France', 'france', 'FR', 'France captivates visitors with the Eiffel Tower, world-renowned cuisine, romantic countryside, and iconic art museums. Paris remains the most visited city in the world.', NULL, '🇫🇷', 1, 4, '2026-03-11 10:56:35'),
(5, 'Singapore', 'singapore', 'SG', 'Singapore, a dazzling city-state, seamlessly blends futuristic architecture, multicultural neighborhoods, lush gardens, and exceptional food culture.', NULL, '🇸🇬', 1, 5, '2026-03-11 10:56:35');
...
INSERT INTO `payments` (`id`, `booking_id`, `invoice_number`, `amount`, `currency_code`, `payment_method`, `status`, `paid_at`, `created_at`) VALUES
(1, 1, 'INV-2026-0001', 25998.00, 'INR', 'Online - UPI', 'Paid', '2026-04-01 05:00:00', '2026-03-11 10:56:36'),
(2, 2, 'INV-2026-0002', 79996.00, 'INR', 'Bank Transfer', 'Pending', NULL, '2026-03-11 10:56:36'),
(3, 3, 'INV-2026-0003', 29997.00, 'INR', 'Cash', 'Paid', '2026-03-18 08:30:00', '2026-03-11 10:56:36'),
(4, 4, 'INV-2026-0004', 69998.00, 'INR', 'Online - Card', 'Paid', '2026-05-28 03:45:00', '2026-03-11 10:56:36'),
(5, 5, 'INV-2026-0005', 49999.00, 'INR', 'Cash', 'Paid', '2026-03-25 11:15:00', '2026-03-11 10:56:36');
...
INSERT INTO `places` (`id`, `city_id`, `name`, `slug`, `description`, `featured_image`, `is_featured`, `sort_order`, `created_at`) VALUES
(1, 1, 'Amer Fort', 'amer-fort', 'Amer Fort (Amber Fort), perched on a hilltop overlooking Maota Lake, is Jaipur\'s most visited attraction. Its grand Rajput architecture and elephant rides make it iconic.', NULL, 1, 0, '2026-03-11 10:56:35'),
(2, 1, 'Hawa Mahal', 'hawa-mahal', 'The Palace of Winds, Hawa Mahal is a stunning five-storey pink sandstone palace with 953 small windows that allowed royal ladies to observe street life.', NULL, 1, 0, '2026-03-11 10:56:35'),
(3, 2, 'Red Fort', 'red-fort', 'The iconic Red Fort (Lal Qila), built by Emperor Shah Jahan in 1639, served as the main residence of Mughal emperors for 200 years.', NULL, 1, 0, '2026-03-11 10:56:35'),
(4, 3, 'Baga Beach', 'baga-beach', 'Baga Beach in North Goa is among the country\'s most popular beaches, famous for water sports, shacks, and vibrant nightlife.', NULL, 1, 0, '2026-03-11 10:56:35'),
(5, 5, 'Burj Khalifa', 'burj-khalifa', 'Standing at 828 meters, the Burj Khalifa is the world\'s tallest building. Its observation deck offers panoramic views of the entire Dubai skyline.', NULL, 1, 0, '2026-03-11 10:56:35');
...
INSERT INTO `states` (`id`, `country_id`, `name`, `slug`, `description`, `featured_image`, `is_featured`, `sort_order`, `created_at`) VALUES
(1, 1, 'Rajasthan', 'rajasthan', 'The Land of Kings — Rajasthan is famous for its majestic forts, lavish palaces, and colorful festivals set amid the Thar Desert.', NULL, 1, 0, '2026-03-11 10:56:35'),
(2, 1, 'Goa', 'goa', 'India\'s smallest state packs a punch with golden beaches, Portuguese architecture, vibrant nightlife, and delicious seafood.', NULL, 1, 0, '2026-03-11 10:56:35'),
(3, 1, 'Delhi', 'delhi', 'India\'s capital is a thrilling mix of Mughal history, colonial architecture, modern malls, and legendary street food.', NULL, 1, 0, '2026-03-11 10:56:35'),
(4, 2, 'Phuket', 'phuket', 'Phuket, Thailand\'s largest island, is famous for its crystalline beaches, vibrant nightlife, and luxury resorts.', NULL, 1, 0, '2026-03-11 10:56:35'),
(5, 3, 'Dubai Emirate', 'dubai-emirate', 'Dubai, a glittering jewel of the Middle East, is the epitome of luxury, innovation, and ambition rising from the desert.', NULL, 1, 0, '2026-03-11 10:56:35');
...
INSERT INTO `testimonials` (`id`, `name`, `location`, `rating`, `review`, `avatar`, `trip_id`, `is_active`, `created_at`) VALUES
(1, 'Rajesh Sharma', 'New Delhi, India', 5, 'Absolutely loved the Jaipur Heritage Tour! IBCC Trip organized everything perfectly — from the hotel pickup to the elephant ride at Amber Fort. Our guide was incredibly knowledgeable. Will book again!', NULL, 1, 1, '2026-03-11 10:56:36'),
(2, 'Priya Singh', 'Mumbai, India', 5, 'Golden Triangle Tour exceeded all expectations. Watching the Taj Mahal at sunrise was a life-changing experience. The 4-star hotels were excellent and the Innova was very comfortable.', NULL, 2, 1, '2026-03-11 10:56:36'),
(3, 'Amit Patel', 'Ahmedabad, India', 5, 'Had an amazing time in Goa! The Dudhsagar waterfall trek was incredible. Beach resort was beautiful. Highly recommend IBCC Trip for Goa packages.', NULL, 3, 1, '2026-03-11 10:56:36'),
(4, 'Sunita Verma', 'Hyderabad, India', 5, 'Thailand trip was absolutely magical. Phi Phi Islands are out of this world! IBCC Trip\'s coordination was flawless — every activity was perfectly timed.', NULL, 4, 1, '2026-03-11 10:56:36'),
(5, 'Mohammed Khan', 'Pune, India', 5, 'Dubai Luxury Experience was worth every rupee! The desert safari dinner was spectacular and the Burj Khalifa sky view was breathtaking. First-class service throughout.', NULL, 5, 1, '2026-03-11 10:56:36');
...
(1, 'Jaipur Heritage Tour', 'jaipur-heritage-tour', '<p>Discover the royal splendor of Jaipur, the Pink City. This carefully crafted heritage tour takes you through magnificent forts, opulent palaces, and vibrant bazaars that tell the tale of Rajasthan\'s rich history.</p><p>Experience authentic Rajasthani culture, savor traditional cuisine, and witness the artistic legacy of the Maharajas through exquisite crafts and architecture.</p>', '[\"Amber Fort elephant ride\",\"Hawa Mahal photography session\",\"City Palace museum tour\",\"Local Rajasthani cuisine experience\",\"Traditional bazaar shopping walk\",\"Sunset at Nahargarh Fort\"]', '[\"3-star hotel accommodation (2 nights)\",\"Daily breakfast\",\"AC vehicle for sightseeing\",\"Professional guide\",\"All monument entry fees\",\"Airport pickup & drop\"]', '[\"Airfare\",\"Personal expenses\",\"Lunch & dinner\",\"Tips & gratuities\",\"Camera fees at monuments\"]', 1, 1, 1, 1, 15000.00, 12999.00, 3, 20, 'https://images.unsplash.com/photo-1599661046827-dacde9ec8a9a?w=1200', NULL, 'Easy', 'Domestic', 1, 1, 0, 0, 'Jaipur Heritage Tour 2026 | IBCC Trip — Best Rajasthan Travel Package', 'Explore Jaipur\'s magnificent forts, palaces & bazaars with IBCC Trip\'s premium heritage tour. 3 days, 2 nights from ₹12,999. Book now!', NULL, NULL, '2026-03-11 10:56:36', '2026-03-11 10:56:36'),
...
(1, 1, 'https://images.unsplash.com/photo-1599661046827-dacde9ec8a9a?w=800', 'Amber Fort Jaipur', 1),
(2, 1, 'https://images.unsplash.com/photo-1477587458883-47145ed94245?w=800', 'Hawa Mahal Jaipur', 2),
(3, 1, 'https://images.unsplash.com/photo-1568495248636-6432b97bd949?w=800', 'City Palace Jaipur', 3),
(4, 1, 'https://images.unsplash.com/photo-1585135497273-1a86b09fe70e?w=800', 'Rajasthani Culture', 4),
...
(1, 1, 1, 'Arrival in Jaipur — The Pink City Awaits', 'Arrive at Jaipur Airport/Railway Station. Check into your hotel. After freshening up, visit the vibrant Johari Bazaar and MI Road for a taste of local life. Welcome dinner at a heritage restaurant. Overnight at hotel.', 'Dinner', 'Jaipur Heritage Hotel'),
(2, 1, 2, 'Jaipur Exploration Day', 'Morning visit to Amber Fort — ride an elephant up to this magnificent 16th-century fort. Explore the Fort\'s Sheesh Mahal (Hall of Mirrors). Post lunch: City Palace Museum, Jantar Mantar (UNESCO World Heritage Site), and the iconic Hawa Mahal. Evening sunset at Nahargarh Fort with panoramic city views.', 'Breakfast', 'Jaipur Heritage Hotel'),
(3, 1, 3, 'Local Culture & Departure', 'Morning visit to Albert Hall Museum. Explore local crafts at Bapu Bazaar — pick up blue pottery, block-print textiles, and gemstones. Farewell lunch. Transfer to airport/station for departure.', 'Breakfast, Lunch', '—'),
...
(6, 5, NULL, 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', NULL);
...
--
ALTER TABLE `testimonials`
  ADD CONSTRAINT `testimonials_ibfk_1` FOREIGN KEY (`trip_id`) REFERENCES `trips` (`id`) ON DELETE SET NULL;
